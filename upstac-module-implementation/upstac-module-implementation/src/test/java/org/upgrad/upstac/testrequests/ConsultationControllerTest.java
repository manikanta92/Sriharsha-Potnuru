...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest testRequest2 = consultationController.assignForConsultation(testRequest.getRequestId());

        assertThat(testRequest.getRequestId(), is(testRequest2.getRequestId()));
        assertThat(RequestStatus.DIAGNOSIS_IN_PROCESS,is(testRequest2.getStatus()));
    ...
    public void calling_updateConsultation_with_valid_test_request_id_should_update_the_request_status_and_update_consultation_details(){
        ...
        assertThat(testRequest1.getConsultation().getSuggestion(), is(DoctorSuggestion.NO_ISSUES));
